		...
		<div class="row-fluid">
			...
			<div id = "restOfPage" style="width:80%; float:left; padding-left:2%">
				...
				<div style="color:white; float:left; padding-left:2%; width:47%;">
					<tabset>
					    <tab heading="Prediction Chart" active=workspace.active>
					            <div style="text-align:center;">
					                <div id="chartDiv" style="text-align:center; width:80%" ng-show="teamScore">
						...
						<tab heading="By lane">
							<div id="statsDiv" style="text-align:center;">
										...
										<div id="directions" class="thumbnail" style="color: black; margin:0 auto; text-align:center;"
